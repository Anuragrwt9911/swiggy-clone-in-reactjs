  ...
  return (
    <div className="h-full w-full z-10  font-[poppins] shadow-lg  flex items-center justify-between bg-black text-white ">
      ...
      <button
        ...
        className="md:hidden absolute top-5 right-4 px-2"
      >
        {showNavItems ? (
      ...
      <ul
        className={` flex items-center   mr-4 flex-col md:flex-row md:static absolute top-[75px] md:bg-transparent md:gap-0 gap-4 bg-white md:text-white text-black md:p-1 p-8 
        transition-all ease-in-out duration-500 ${
          !showNavItems ? " right-0 " : " text-white right-[-210px] "
        } `}
      >
